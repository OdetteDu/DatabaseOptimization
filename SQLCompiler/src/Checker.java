...
public class Checker {
	...
	private Map<String, TableData> database;
	 ...
	 * @param mySelect 
	 */
	public Checker(Map<String, TableData> database, ArrayList<Expression> select, Map<String, String> from, 
	...
	private String getType(Expression e)
	{
		...
		else if(type.equals("identifier"))
		{
			...
			String attr=identifier.substring(identifier.indexOf(".")+1, identifier.length());
			String table=from.get(id);
			TableData td=database.get(table);
			if(td!=null)
			{
