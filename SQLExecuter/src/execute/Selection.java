...
public class Selection {
  ...
  public Selection (ArrayList <Attribute> attsInInputFile,
    ...
    try {            
      ...
      String cmdarr = "g++ -O3 -o " + cppDir + "a.out -Wno-write-strings " + cppDir + "Selection.cc";
    ...
    try {            
      ...
      //System.out.println(cppDir + "a.out " + inFile + " " + outFile);
      Process proc = rt.exec (cppDir + "a.out " + inFile + " " + outFile);
      int exitVal = proc.waitFor();
      if (exitVal != 0) {
